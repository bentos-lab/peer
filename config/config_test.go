...
func TestLoadUsesDefaultsWhenNoEnv(t *testing.T) {
	...
	unsetEnv(t, "GITLAB_WEBHOOK_SECRET")
	unsetEnv(t, "GITLAB_API_BASE_URL")
	unsetEnv(t, "GITLAB_WEBHOOK_URL")
	unsetEnv(t, "GITLAB_SYNC_INTERVAL_MINUTES")
	unsetEnv(t, "GITLAB_SYNC_STATE_PATH")
	unsetEnv(t, "GITLAB_HOST")
	unsetEnv(t, "GITLAB_TOKEN")
	unsetEnv(t, "GITLAB_WEBHOOK_SECRET")
	unsetEnv(t, "GITLAB_API_BASE_URL")
	unsetEnv(t, "GITLAB_WEBHOOK_URL")
	...
	require.Equal(t, "", cfg.Server.GitLab.Token)
	require.Equal(t, "", cfg.Server.GitLab.WebhookSecret)
...
func TestLoadReadsDotEnvWhenEnvMissing(t *testing.T) {
	...
	require.Equal(t, "gitlab-token", cfg.Server.GitLab.Token)
	require.Equal(t, "gitlab-secret", cfg.Server.GitLab.WebhookSecret)
	require.Equal(t, "https://gitlab.example.com/api/v4", cfg.Server.GitLab.APIBaseURL)
...
func TestLoadDoesNotOverrideExistingEnvWithDotEnv(t *testing.T) {
	...
	t.Setenv("GITLAB_TOKEN", "set-gitlab-token")
	t.Setenv("GITLAB_WEBHOOK_SECRET", "set-gitlab-secret")
	t.Setenv("GITLAB_API_BASE_URL", "https://gitlab.env/api/v4")
	t.Setenv("GITLAB_WEBHOOK_URL", "https://env.example.com/webhook/gitlab")
	t.Setenv("GITLAB_SYNC_INTERVAL_MINUTES", "9")
	t.Setenv("GITLAB_SYNC_STATE_PATH", "~/env-state.json")
	...
	require.Equal(t, "set-gitlab-token", cfg.Server.GitLab.Token)
	require.Equal(t, "set-gitlab-secret", cfg.Server.GitLab.WebhookSecret)
	require.Equal(t, "https://gitlab.env/api/v4", cfg.Server.GitLab.APIBaseURL)
	require.Equal(t, "https://env.example.com/webhook/gitlab", cfg.Server.GitLab.WebhookURL)
	require.Equal(t, 9, cfg.Server.GitLab.SyncInterval)
	require.Equal(t, "~/env-state.json", cfg.Server.GitLab.SyncStatePath)
