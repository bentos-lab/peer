...
## Overview
`autogit` is a CLI that reviews and summarizes pull/merge requests, replies to PR comments, and can generate docs/tests/comments. It works both on PR/MR contexts and on local changes or diffs in a repository.
...
## Note
- When the user requests a review, ask whether an overview should also be generated.
...
## Execution Notes
- The tool is available as a global CLI: `autogit`.
