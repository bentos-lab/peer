...
func TestGenerateIssueAlignmentUsesKeyIdeas(t *testing.T) {
	...
	require.Contains(t, formatter.lastJSONArgs[0].Messages[0], "Requirement A")
	require.Contains(t, formatter.lastJSONArgs[0].Messages[0], "Requirement B")
	...
	require.Contains(t, agent.lastTask, "Key ideas (true requirements):")
